"""
Django settings for tribepool project.
...
ALLOWED_HOSTS = ["tribepool.xyz", "www.tribepool.xyz", "localhost", "127.0.0.1"]
...
WSGI_APPLICATION = "tribepool.wsgi.application"
